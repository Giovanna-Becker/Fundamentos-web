...
// var nome = window.document.querySelector('#nome') - buscar por classe
//nome.style.width = '100%' - Modificar CSS pelo Java Script
...
function validarNome(){
    ...
    if(nome.value.length < 2){
        ...
        txtNome.style.color = 'rgb(143, 7, 64)'
        nomeOk = false
    }else{
...
function validarEmail(){
    ...
    if(email.value.indexOf('@') == -1 || email.value.indexOf('.com') == -1){
        ...
        txtEmail.style.color = 'rgb(143, 7, 64)'
        emailOk = false
    }else{
...
function validarAssunto(){
    ...
    if(assunto.value.length < 20){
        ...
        txtAssunto.style.color = 'rgb(143, 7, 64)'
        assuntoOk = false
